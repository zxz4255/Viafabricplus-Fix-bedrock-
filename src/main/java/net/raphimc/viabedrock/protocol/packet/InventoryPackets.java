...
import net.raphimc.viabedrock.protocol.inventory.ItemStackResponseBridge;
...
public class InventoryPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        protocol.registerClientbound(ClientboundBedrockPackets.ITEM_STACK_RESPONSE, null, ItemStackResponseBridge::handleResponse);
